...
class ProductController extends Controller
{
    ...
    public function getProduct(){
    	$productlist= DB::table('vp_products')->join('vp_categories','vp_products.prod_cate','=','vp_categories.cate_id')->orderBy('prod_id','desc')->get();
    	return view('backend.product',compact('productlist'));
    }
    public function getAddProduct(){
    	$catelist = Category::all();
    	return view('backend.addproduct',compact('catelist'));
