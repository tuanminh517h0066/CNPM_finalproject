						...
						<div id="list-cart">
							...
							<form>
								<table class="table table-bordered .table-responsive text-center">
									...
									<tr>
										<td><img width="250px" class="img-responsive" src="{{asset('lib/storage/app/avatar/'.$item->attributes->img)}}"></td>
										<td>{{$item->name}}</td>
										<td>
										...
										<td><span class="price">{{number_format($item->price*$item->quantity,0,',','.')}}đ đ</span></td>
										<td><a href="{{asset('cart/delete/'.$item->prod_Id)}}">Xóa</a></td>
									</tr>
									@endforeach
